...
function Calendar(beginYear, endYear, language, patternDelimiter, date2StringPattern, string2DatePattern) {
	...
	//TODO changed the language to 1(english)
	this.language  = 1  || 0;
...
Calendar.prototype.draw = function() {
	...
	this.form.clearButton.onclick = function () {calendar.dateControl.value = "None";calendar.hide();}
...
Calendar.prototype.show = function (dateControl, popuControl) {
	...
	this.bindYear();
	this.bindMonth();
	if (dateControl.value.length > 0&&dateControl.value!='None'){
